...
public class HtmlTemplate {
	...
	public static String forgetPasswordTemplate(String email, String link) {
		...
		String html = "<!DOCTYPE html>\r\n" + "<html lang=\"en-US\">\r\n" + "<head>\r\n"
				...
				+ "            <p style=\"font-weight: 600; font-size: 20px; margin: 0 0 20px; color: #263238;\">Hello  <span style=\"font-weight: 700; display: inline-block; color: #52A5DC;\">"
				+ email + ",</span></p>\r\n"
	...
	public static String htmlSentOtp(String otp) {
		...
		String page = "<!DOCTYPE html>\r\n" + "<html lang=\"en-US\">\r\n" + "<head>\r\n"
				...
				+ "            </a>\r\n" + "          </td>\r\n" + "        </tr>\r\n" + "        <tr>\r\n"
				+ "          <td style=\" background-color: #f8f9fc; border:1px solid #e1e4ef; border-radius: 4px; font-size: 14px; line-height: 24px; padding: 50px 40px; text-align: left; color: #626262;\" >\r\n"
				+ "            <p style=\"font-weight: 600; font-size: 20px; margin: 0 0 20px; color: #263238;\">Your OTP each : <span style=\"font-weight: 700; display: inline-block; color: #52A5DC;\">"
				+ otp + ",</span></p>\r\n"
				+ "            <p style=\"font-weight: 600; font-size: 16px; margin: 0 0 20px; color: #263238;\">\r\n"
				+ "              Greetings from Amwal.\r\n" + "            </p>\r\n"
				+ "            <p style=\"margin: 0 0 15px;\">\r\n"
				+ "              \r\n" + "			</p>\r\n"
				+ "          </td>\r\n" + "        </tr>\r\n" + "      </tbody>\r\n" + "    </table>\r\n"
				+ "  </div>\r\n" + "</body>\r\n" + "</html>";
...
//		 }
		return "<!DOCTYPE HTML\r\n"
				...
				+ "                                        style=\"line-height: 34.2px; font-size: 18px;\">Hi "
				+ "jitendra rathore" + ",</span></strong></span></p>\r\n"
				+ "                                <p style=\"font-size: 14px; line-height: 190%;\"><span\r\n"
...
//		 		+ "                                    Your OTP - "+otp+".\r\n"
	...
	public static String accountBlockedReminderTemplate(String email, String link) {
		String html = "<!DOCTYPE html>\r\n" + "<html lang=\"en-US\">\r\n" + "<head>\r\n"
				+ "  <meta charset=\"utf-8\">\r\n" + "  <meta name=\"x-apple-disable-message-reformatting\">\r\n"
				+ "  <meta http-equiv=\"x-ua-compatible\" content=\"ie=edge\">\r\n"
				+ "  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\r\n"
				...
				+ "            <p style=\"margin: 0 0 15px;\">\r\n"
				+ "You have not updated your password, so your account has been blocked without creating new password you can not access your account,\n Kindly click on the button below to reset your password\r\n"
				+ "			</p>\r\n"
	...
	public static String ticketGeneratedTemplate(String email, Long ticketId) {
		String html = "<!DOCTYPE html>\r\n" + "<html lang=\"en-US\">\r\n" + "<head>\r\n"
				+ "  <meta charset=\"utf-8\">\r\n" + "  <meta name=\"x-apple-disable-message-reformatting\">\r\n"
				+ "  <meta http-equiv=\"x-ua-compatible\" content=\"ie=edge\">\r\n"
				+ "  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\r\n"
				...
				+ " generated successfully you will be shortly notified by support team regarding your consern.\r\n"
				+ "			</p>\r\n"
...
//				+ "'\"  target=\"_blank\">Reset Password</a> \r\n" + "            </p>\r\n"
	...
	public static String replayOnTicketTemplate(String email, SupportRequestPayload supportRequestPayload) {
		String html = "<!DOCTYPE html>\r\n" + "<html lang=\"en-US\">\r\n" + "<head>\r\n"
				+ "  <meta charset=\"utf-8\">\r\n" + "  <meta name=\"x-apple-disable-message-reformatting\">\r\n"
				+ "  <meta http-equiv=\"x-ua-compatible\" content=\"ie=edge\">\r\n"
				+ "  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\r\n"
				...
				+ email + ",</span></p>\r\n"
				+ "            <p style=\"font-weight: 600; font-size: 16px; margin: 0 0 20px; color: #263238;\">\r\n"
				+ "              We are working on your request with following details.\r\n" + "            </p>\r\n"

				+ "            <p style=\"margin: 0 0 15px;\">\r\n" + "Ticket number is : "
				+ "<b style=\"color: #263238;\">" + supportRequestPayload.getId() + "</b>		</p>\r\n"

				+ "            <p style=\"margin: 0 0 15px;\">\r\n" + "Ticket status is : "
				+ "<b style=\"color: #263238;\">\r\n" + " Pending " + "</b>\r\n" + "</p>\r\n"

				+ "            <p style=\"margin: 0 0 15px;\">\r\n" + "Ticket type is : "
				+ "<b style=\"color: #263238;\">" + supportRequestPayload.getTicketType() + "</b>	</p>\r\n"

				+ "            <p style=\"margin: 0 0 15px;\">\r\n" + "Ticket desceription is : "
				+ "<b style=\"color: #263238;\">" + supportRequestPayload.getTicketDescription() + "</b>	</p>\r\n"

				+ "			<p style=\"margin: 0 0 15px;\">\r\n" + "            </p>\r\n"

				+ "            <p style=\"margin: 0; color: #263238;\">\r\n"
				+ "              <strong>Regards,<br>Support Team</strong>\r\n" + "            </p>\r\n"
				+ "			<p></p>\r\n" + "          </td>\r\n" + "        </tr>\r\n" + "      </tbody>\r\n"
				+ "    </table>\r\n" + "  </div>\r\n" + "</body>\r\n" + "</html>";
		return html;
	}

	public static String ticketClosedTemplate(String email, SupportRequestPayload supportRequestPayload) {
		String html = "<!DOCTYPE html>\r\n" + "<html lang=\"en-US\">\r\n" + "<head>\r\n"
				+ "  <meta charset=\"utf-8\">\r\n" + "  <meta name=\"x-apple-disable-message-reformatting\">\r\n"
				+ "  <meta http-equiv=\"x-ua-compatible\" content=\"ie=edge\">\r\n"
				+ "  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\r\n"
				...
				+ email + ",</span></p>\r\n"
				+ "            <p style=\"font-weight: 600; font-size: 16px; margin: 0 0 20px; color: #263238;\">\r\n"
				+ "              Your ticket have closed successfully!\r\n" + "            </p>\r\n"
	...
	public static String sendEmailForAdminDashboard(String email, String toEmail, String message) {
//        String html = "<!DOCTYPE html>\r\n"
//                + "<html lang=\"en-US\">\r\n"
//                + "<head>\r\n"
//                + " <meta charset=\"utf-8\">\r\n"
...
//                + " <tr>\r\n"
//                + " <td style=\" background-color: #f8f9fc; border:1px solid #e1e4ef; border-radius: 4px; font-size: 14px; line-height: 24px; padding: 50px 40px; text-align: left; color: #626262;\" >\r\n"
//         //       + " <p style=\"font-weight: 600; font-size: 20px; margin: 0 0 20px; color: #263238;\">Hello <span style=\"font-weight: 700; display: inline-block; color: #52A5DC;\">" + toEmail + ",</span></p>\r\n"
//                + " <p style=\"font-weight: 600; font-size: 20px; margin: 0 0 20px; color: #263238; font-family: YourDesiredFont, sans-serif;\">Hello <span style=\"font-weight: 700; display: inline-block; color: #52A5DC;\">" + toEmail + ",</span></p>\r\n"
//                + " <p style=\"font-weight: 600; font-size: 16px; margin: 0 0 20px; color: #263238;\">\r\n"
//                + " Amwal Inbox \r\n"
//                + " </p>\r\n"
//                + " <p style=\"margin: 0;\">\r\n"
//                + " <span style=\"font-weight: 700; display: inline-block; color: #52A5DC;\">Sender Email :-" + email + "</span>\r\n"
//                + " </p>\r\n"
//                + " <p style=\"margin: 0;\">\r\n"
//                + " <span style=\"font-weight: 700; display: inline-block; color: #52A5DC;\">Message :" + message + "</span>\r\n"
//                + " </p>\r\n"
//                + " <p style=\"margin: 0 0 15px;\">\r\n"
//                + " </p>\r\n"
//                + " <p style=\"margin: 0; color: #52A5DC;\">\r\n"
//                + " <strong>Regards,<br>Team Amwal</strong>\r\n"
//                + " </p>\r\n"
//                + " <p></p>\r\n"
//                + " </td>\r\n"
...
//	            + " <tr>\r\n"
//	            + " <td style=\" background-color: #f8f9fc; border:1px solid #e1e4ef; border-radius: 4px; font-size: 14px; line-height: 24px; padding: 50px 40px; text-align: left; color: #626262;\" >\r\n"
//	            + " <p style=\"font-weight: 600; font-size: 16px; margin: 0 0 20px; color: #263238;\">Hello <span style=\"font-weight: 700; display: inline-block; color: #52A5DC;\">" + toEmail + ",</span></p>\r\n"
//	            + " <p style=\"font-weight: 600; font-size: 14px; margin: 0 0 20px; color: #263238;\">\r\n"
//	            + " Amwal Inbox \r\n"
//	            + " </p>\r\n"
//	            + " <p style=\"margin: 0;\">\r\n"
//	            + " <span style=\"font-weight: 700; display: inline-block; color: #52A5DC;\">Sender Email :-" + email + "</span>\r\n"
//	            + " </p>\r\n"
//	            + " <p style=\"margin: 0;\">\r\n"
//	            + " <span style=\"font-weight: 700; display: inline-block; color: #3e3a3a;\">Message:- " + message + "</span>\r\n"
//	            + " </p>\r\n"
//	            + " <p style=\"margin: 0 0 15px;\">\r\n"
//	            + " </p>\r\n"
//	            + " <p style=\"margin: 0; color: #52A5DC;\">\r\n"
...
//	
		String html = "<!DOCTYPE html>\r\n"
		        ...
		        + " </p>\r\n"
		        + " <p style=\"margin: 0;\">\r\n"
		        + " <span style=\"font-weight: 700; display: inline-block; color: #3e3a3a;\">Sender Email:- " + email + "</span>\r\n"
		        + " </p>\r\n"
		        + " <p style=\"margin: 0;\">\r\n"
		        + " <span style=\"font-weight: 700; display: inline-block; color: #3e3a3a;\">Message:- " + message + "</span>\r\n"
		        + " </p>\r\n"
